# -*- coding: utf-8 -*-
{
    'name': "Inputmask and prefix and suffix Widget",

    'summary': """
   A Widget to make masks on form fields and adds prefix and suffix""",
...
Based on Gilvan Leal, "https://gilvanleal.github.io/odoowidgets/",
...
- Aliases:
   ...
   * `Other <https://github.com/RobinHerbots/Inputmask/blob/3.x/README_other.md>`_""",
    ...
    "qweb": ['static/src/xml/inputmask_widget.xml'],
